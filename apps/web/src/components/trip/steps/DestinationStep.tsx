...
export default function DestinationStep({ onNext, onBack }: DestinationStepProps) {
  ...
  ].filter(city => city.name !== origin); // Don't show origin as a destination option
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold text-gray-900">¿Hacia dónde vas?</h2>
        <p className="mt-1 text-sm text-gray-500">
          Selecciona la ciudad de destino de tu viaje
        </p>
      </div>
